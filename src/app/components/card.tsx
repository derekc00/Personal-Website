      ...
      <div className="relative h-48 overflow-hidden">
        {imageLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-gray-100 dark:bg-gray-900 animate-pulse">
            <svg className="w-10 h-10 text-gray-300 dark:text-gray-700" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Link href={`/blog/${slug}`}>
          <Image
            className={`object-cover w-full h-48 transition-transform duration-300 group-hover:scale-105 ${imageLoading ? 'opacity-0' : 'opacity-100'}`}
